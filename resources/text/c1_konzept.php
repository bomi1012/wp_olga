...
<div class="article_text c1" id="text_schwerpunkte">
    ...
    <div style="width: 480px">
        ...
        <div class="line-oben row-r">
            <p style="font-size: 19px;">Kognitiver Bereich</p>
        </div>
    </div>
    <div style="width: 480px;">
        <div class="row-al">
            <p>Regelbewusstsein<br/>
                Selbstbewusstsein entwickeln<br/>
                Kontakte kn&uuml;pfen<br/>
        ...
        <div class="row-ar">
            <p>Merkf&auml;higkeit<br/>
                Zusammenh&auml;nge erkennen<br/>
                Konzentrationsf&auml;higkeit<br/>
                Begriffsbildung (Sprache)
            </p>
        </div>
    </div>
    <div style="width: 480px">
        <div class="line-oben row-l">
            <p style="font-size: 19px;">Emotionaler Bereich</p>
        </div>
        <div class="line-oben row-r">
            <p style="font-size: 19px;">Kreativer Bereich</p>
        </div>
    </div>
    <div style="width: 480px;">
        <div class="row-al">
            <p>Eigene Meinung vertreten<br/>
                Gef&uuml;hle mitteilen und ausdr&uuml;cken<br/>
                Selbstbewusstsein entwickeln und st&auml;rken

            </p>
        </div>
        <div class="row-ar">
            <p>Phantasie entwickeln<br/>
                Ideen entwickeln und diese umsetzen<br/>
...
<div class="article_text c1" id="text_tag">  
    ...
    <div class="rows" style="margin-bottom: 17px">
        ...
        <div class="table_rigth1">
            <p>Gemeinsame Zwischenmahlzeit (Obst, Gem&uuml;se) mit Getr&auml;nken</p>        
        </div>
        <div class="table_left1">
            <p>09:30 - 11:00</p>
        </div>
        <div class="table_rigth1">
            <p>Gezieltes Angebot mit gemeinsamen Spielen und Aktivit&auml;ten</p>        
        </div>
        <div class="table_left1">
            <p>11:00 - 12:00</p>
        </div>
